...
export class DaterangepickerComponent implements OnInit {
  ...
  isCustomRangeSet() {
    return (this.customRangeStartDate != null && this.customRangeEndDate != null);
  }

  getCustomRangeString() {
  ...
  clickApply(e?) {
    ...
    if (this.chosenRange === this.locale.customRangeLabel) {
      this.customRangeStartDate = this.startDate;
      this.customRangeEndDate = this.endDate;
    }
  ...
  clickRange(e, label) {
    ...
    if (label === this.locale.customRangeLabel) {
      ...
      if (!this.isCustomRangeSet()) {
        ...
        this.clickApply();
        this.clickApply(); // this is a feature now
      }
  ...
  clear() {
    ...
    this.customRangeStartDate = null;
    this.customRangeEndDate = null;
